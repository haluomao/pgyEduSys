...
public class UploadLog {
    ...
    public static final class Builder {
        ...
        public UploadLog build() {
            ...
            uploadLog.setDownloadUrl(downloadUrl);
    ...
    public boolean equals(Object o) {
        ...
        return id == uploadLog.id
                ...
                && Objects.equal(downloadUrl, uploadLog.downloadUrl)
                && status == uploadLog.status;
    }

    @Override
    public int hashCode() {
        return Objects.hashCode(id, uploaderId, filename, fileType, signature, path, url, downloadUrl, size, status);
    }
